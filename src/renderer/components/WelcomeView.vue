<template>
  <v-layout row wrap justify-center id="wrapper">
    <v-flex xs12 md4 offset-md1 class="text-xs-center centered">
      <img id="logo" class="logo" src="~@/renderer/assets/logo.png" alt="electron-vue">
    </v-flex>
    ...
    <v-flex xs10 class="mt-4">
      <v-card>
        ...
        <v-card-actions class="pt-3 pb-3">
          <v-spacer></v-spacer>
          <v-btn class="link-btn" @click="ui.show = true">Vue</v-btn>
          <v-spacer></v-spacer>
...
<script>
  ...
  export default {
    name: 'welcome',
    components: { SystemInformation, PeripheralPickerDialog },
    data () {
      return {
        ui: {
          show: false
